...
import { EXAMPLE_USER_01, EXAMPLE_USER_02 } from "src/api/handler/user/|users|:userId";
 ...
 * @package
 */
export const EXAMPLE_NOTE_DB: NoteType[] = [
  {
