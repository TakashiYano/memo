...
import { useSearch } from "src/pages-component/search/useSearch";
    ...
    <form className="relative w-full" onSubmit={handleSubmit}>
      ...
      {inputValue && isLoading && (
        ...
        <span>
          <svg
            aria-hidden="true"
            className="absolute right-4 top-2.5 h-5 w-5 animate-spin"
            viewBox="0 0 100 101"
            fill="none"
      ...
      {inputValue && !isLoading && (
        // クリアボタン
        <Button key="delete" className="absolute right-4 top-2.5 h-5 w-5" onClick={handleClose}>
